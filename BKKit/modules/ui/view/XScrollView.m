...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
		...
		self.stateLabel = createLabel(labelFrame,[UIFont systemFontOfSize:14], nil,[UIColor blackColor],[UIColor whiteColor],CGSizeMake(0, -1),NSTextAlignmentCenter,0,NSLineBreakByWordWrapping);
		...
		self.dateLabel = createLabel(labelFrame,[UIFont systemFontOfSize:12],nil,[UIColor colorWithWhite:0.3 alpha:1],nil,CGSizeZero,NSTextAlignmentCenter,0,NSLineBreakByWordWrapping) ;
