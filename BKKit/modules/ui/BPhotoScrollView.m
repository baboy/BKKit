...
- (UIView *)bottomView{
    ...
    UILabel *titleLabel = createLabel(rect, [UIFont systemFontOfSize:14], nil, [UIColor whiteColor], nil, CGSizeZero, NSTextAlignmentLeft, 1, NSLineBreakByTruncatingTail);
...
- (void)viewFullScreen:(id)sender{
    ...
    XUIImageView *imgView = [[XUIImageView alloc] initWithFrame:rect] ;
