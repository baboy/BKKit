...
+ (UIView *)createIndicator:(BOOL)withIndicator icon:(UIImage *)icon message:(NSString *)msg inView:(UIView *)container{
    ...
    UILabel *label = createLabel(rect, BIndicatorTextFont, nil, [UIColor whiteColor], [UIColor blackColor], CGSizeMake(0, -1), NSTextAlignmentCenter, 0, NSLineBreakByTruncatingTail);
	label.text = msg;
